...
if (loadData)
    ...
    %         end
    %     end
    save(strjoin([savefilename '_NonregularizedErrors'], ''));
    disp(strjoin(['Saved nonregularized errors as ' savefilename  '_NonregularizedErrors'],''));
    fprintf('\n');
end
...
if (optimization)
    ...
    relativeLambdas = [0.007]; %   [1 0.5 0.2 0.1 0.05 0.02 0.01]; % [0.7 0.07] [2 5] [7 10]
